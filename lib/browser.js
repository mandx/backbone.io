(function() {
    ...
    Backbone.sync = function(method, model, options) {
        var backend = _.result(model, 'backend') || (model.collection && _.result(model.collection, 'backend'));
    ...
    Backbone.Collection = (function(Parent) {
        ...
        var Child = function(models, options) {
            options = options || {};
            this.backend = options.backend || this.backend;
            if (this.backend) {
    ...
    function buildBackend(collection) {
        ...
        var options = _.result(collection, 'backend');
        var name, channel;
